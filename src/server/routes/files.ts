...
router.clearUndoCache = (workspacePath: any) => {
  if (workspacePath) {
 ...
 */
router.get('/undo-cache', (req: any, res: any, next: any) => {
  try {
 ...
 */
router.post('/undo-cache', (req: any, res: any) => {
 ...
 */
router.delete('/undo-cache', (req: any, res: any) => {
  const filePath = req.query.path;
  if (filePath) {
 ...
 */
router.get('/parent', (req: any, res: any) => {
  const filePath = req.query.path;
  if (!filePath) {
 ...
 */
router.get('/browse', (req: any, res: any, next: any) => {
  try {
    const filePath = req.query.path || '';
 ...
 */
router.get('/raw', (req: any, res: any, next: any) => {
  try {
    const filePath = req.query.path;
    if (!filePath) {
 ...
 */
router.get('/read', (req: any, res: any, next: any) => {
  try {
    const filePath = req.query.path;
    if (!filePath) {
 ...
 */
router.post('/write', (req: any, res: any, next: any) => {
  try {
 ...
 */
router.post('/mkdir', (req: any, res: any, next: any) => {
  try {
 ...
 */
router.post('/rename', (req: any, res: any, next: any) => {
  try {
 ...
 */
router.post('/set-workspace', (req: any, res: any, next: any) => {
  try {
    ...
    // 广播工作区变更事件
    const bs = (global as any).__broadcastService;
    if (bs) {
 ...
 */
router.get('/workspace-info', (req: any, res: any) => {
 ...
 */
router.post('/workspace', (req: any, res: any, next: any) => {
  try {
