 ...
 */
router.post('/:id/start', async (req: any, res: any, next: any) => {
  try {
 ...
 */
router.post('/:id/resume', async (req: any, res: any, next: any) => {
  try {
 ...
 */
router.delete('/:id/items/:itemId', (req: any, res: any, next: any) => {
  try {
