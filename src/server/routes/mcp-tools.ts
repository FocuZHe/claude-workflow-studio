 ...
 */
router.get('/agent/:agentId', (req: any, res: any, next: any) => {
  try {
 ...
 */
router.post('/:id/install', (req: any, res: any, next: any) => {
  try {
 ...
 */
router.post('/:id/test', async (req: any, res: any, next: any) => {
  try {
    const { id } = req.params;
 ...
 */
router.post('/:id/validate', (req: any, res: any, next: any) => {
  try {
    const { id } = req.params;
    const tool = McpService.getById(id);
 ...
 */
router.delete('/:id/uninstall', (req: any, res: any, next: any) => {
  try {
