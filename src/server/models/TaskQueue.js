...
class TaskQueueModel {
  /**
   * Get valid transitions for a queue status
   */
  ...
  /**
   * Find all queues with optional filters
   */
  ...
  /**
   * Update a specific item's status within a queue
   */
  ...
  /**
   * Get the next pending item starting from currentItemIndex
   */
  ...
  /**
   * Persist all task queues to the global data/task-queues.json.
   */
  static _persist() {
