 ...
 */
function requireFields(fields: string[]): any {
 ...
 */
function validateString(field: string, min?: number, max?: number): any {
  return (req: any, res: any, next: any) => {
 ...
 * Validate enum field
 */
function validateEnum(field: string, allowedValues: string[]): any {
  return (req: any, res: any, next: any) => {
    const value = req.body[field];
    if (value !== undefined && value !== null) {
 ...
 */
function validateNumber(field: string, min?: number, max?: number): any {
  return (req: any, res: any, next: any) => {
    const value = req.body[field];
    if (value !== undefined && value !== null) {
 ...
 */
function validatePagination(req: any, res: any, next: any): void {
 ...
 */
function validate(...middlewares: any[]): any {
  return (req: any, res: any, next: any) => {
    let idx = 0;
    function runNext(err?: any): void {
