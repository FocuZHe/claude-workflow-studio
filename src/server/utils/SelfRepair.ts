 ...
 */
function getAdaptiveDelay(lastError: any, attempt: number, baseDelay = 1000): number {
 ...
 */
function getSelfRepairHint(error: any): string {
 ...
 */
function truncateInput(input: string, ratio = 0.7): string {
...
function isRepeatedFailure(previousError: any, currentError: any): boolean {
 ...
 */
function shouldStopRetry(lastError: any, sameErrorCount: number): boolean {
