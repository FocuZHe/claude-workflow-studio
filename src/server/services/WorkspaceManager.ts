...
export class WorkspaceManager extends EventEmitter {
  private static _workspaces: Map<string, Workspace> = new Map();
   ...
   */
  private static _updateWorkspaceIds(wsPath: string, newWsId: string): void {
    try {
