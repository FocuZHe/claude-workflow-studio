// ═══════════════════════════════════════════════
// AgentCreate — Creation Form Modal
// ═══════════════════════════════════════════════
    ...
    if (roleEl) {
      roleEl.addEventListener('change', (e) => {
        ...
        if (preset) {
          ...
          if (promptEl && !promptEl.dataset.userModified) promptEl.value = preset.systemPrompt;
          if (modelEl && !modelEl.dataset.userModified) modelEl.value = preset.model;
          if (tempEl && !tempEl.dataset.userModified) tempEl.value = preset.temperature;
        }
      });
    }
