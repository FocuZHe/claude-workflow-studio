// ═══════════════════════════════════════════════
// Workspaces Page — Multi-workspace management
// ═══════════════════════════════════════════════
...
window.WorkspacesPage = (() => {
    ...
    return `
      <div class="card hover-lift" data-id="${ws.id}">
        ...
        <div style="display:flex;gap:6px;margin-top:12px;">
          ...
          <button class="btn btn-sm btn-danger ws-deactivate-btn" data-id="${ws.id}">停用</button>
        </div>
      </div>
    `;
  }
  ...
  function updateNavbarWorkspaceCount() {
    ...
    if (el) {
      el.textContent = workspaces.length;
    }
  }
