 ...
 * @param {number} currentTotal - Number of items currently loaded
 * @param {number} totalCount - Total number of items available
 * @param {string} buttonId - DOM id for the button
 * @returns {string} HTML string (empty if all items loaded)
 */
 ...
 * @param {Function} loadFn - Async function to call on click
 */
...
window.Icon = (() => {
   ...
   * @param {string} name - Icon name (matches id in icons.svg, e.g. 'dashboard')
