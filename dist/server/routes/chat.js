 ...
 */
router.post('/', validate(validateString('title', 0, 200), validateString('systemPrompt', 0, 5000)), (req, res, next) => {
    try {
 ...
 */
router.put('/:id', validate(validateString('title', 0, 200), validateString('model', 0, 100), validateString('systemPrompt', 0, 5000)), (req, res, next) => {
    try {
 ...
 */
router.post('/:id/messages', validate(requireFields(['content'])), async (req, res, next) => {
    try {
