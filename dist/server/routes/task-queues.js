 ...
 */
router.put('/:id', validate(validateString('name', 1, 200), validateString('description', 0, 2000)), (req, res, next) => {
    try {
 ...
 */
router.post('/:id/items', validate(requireFields(['input'])), (req, res, next) => {
    try {
