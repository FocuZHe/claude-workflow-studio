 ...
 */
router.post('/', validate(requireFields(['name', 'content']), validateString('name', 1, 200), validateString('content', 1, 10000), validateString('description', 0, 2000)), (req, res, next) => {
    try {
 ...
 */
router.put('/:id', validate(validateString('name', 1, 200), validateString('content', 1, 10000), validateString('description', 0, 2000)), (req, res, next) => {
    try {
